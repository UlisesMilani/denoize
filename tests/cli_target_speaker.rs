...
const REQUIRED_STRATA: &[(&str, denoize::TargetSpeakerStratumKind)] = &[
    ("channel-mismatch", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("child-speaker", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("code-switching", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("codec-enrollment", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("different-sex", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("many-interferers", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("noisy-enrollment", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("one-interferer", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("real-t-conversation", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("reverberant-enrollment", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("same-sex", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("same-words", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("similar-voices", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("singing", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("speech-absent", denoize::TargetSpeakerStratumKind::TargetAbsent),
    ("target-absent", denoize::TargetSpeakerStratumKind::TargetAbsent),
    ("target-absent-same-words", denoize::TargetSpeakerStratumKind::TargetAbsent),
    ("target-absent-similar-interferer", denoize::TargetSpeakerStratumKind::TargetAbsent),
    ("target-present-clean", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("ts-superb", denoize::TargetSpeakerStratumKind::TargetPresent),
    ("unseen-domain", denoize::TargetSpeakerStratumKind::TargetPresent),
...
fn metrics(kind: denoize::TargetSpeakerStratumKind) -> Vec<denoize::TargetSpeakerMetricOutcome> {
    let values: &[(&str, denoize::TargetSpeakerMetricOperator, f64)] = match kind {
        denoize::TargetSpeakerStratumKind::TargetPresent => &[
            ("content.target-word-error-rate", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.35),
            ("extraction.si-sdr-improvement-db", denoize::TargetSpeakerMetricOperator::GreaterOrEqual, 3.0),
            ("interferer.speaker-similarity", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.30),
            ("interferer.word-leakage-rate", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.02),
            ("output.duration-error-frames", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.0),
            ("output.non-finite-samples", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.0),
            ("perceptual.dnsmos-p808", denoize::TargetSpeakerMetricOperator::GreaterOrEqual, 3.0),
            ("presence.recall", denoize::TargetSpeakerMetricOperator::GreaterOrEqual, 0.95),
            ("speaker.target-similarity", denoize::TargetSpeakerMetricOperator::GreaterOrEqual, 0.70),
        ],
        denoize::TargetSpeakerStratumKind::TargetAbsent => &[
            ("interferer.speaker-similarity", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.30),
            ("interferer.word-leakage-rate", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.01),
            ("output.duration-error-frames", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.0),
            ("output.non-finite-samples", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.0),
            ("output.rms-dbfs", denoize::TargetSpeakerMetricOperator::LessOrEqual, -60.0),
            ("presence.false-positive-rate", denoize::TargetSpeakerMetricOperator::LessOrEqual, 0.01),
        ],
    };
    values
        .iter()
        .map(|(name, operator, limit)| denoize::TargetSpeakerMetricOutcome {
            metric: (*name).into(),
            value: *limit,
            operator: *operator,
            limit: *limit,
