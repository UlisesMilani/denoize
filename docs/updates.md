...
payloads and verifies them before candidate activation. The unpublished
v0.78.0 build tag is not an accepted update source.

## v0.77.0 compatibility gate

This release accepts exact transitions from v0.75.0 and v0.76.0. Every one of
the six application targets includes both authenticated offline rollback
payloads and verifies them before candidate activation.

## v0.76.0 compatibility gate

This release accepts exact transitions from v0.74.0 and v0.75.0. Every one of
the six application targets includes both authenticated offline rollback
payloads and verifies them before candidate activation.
